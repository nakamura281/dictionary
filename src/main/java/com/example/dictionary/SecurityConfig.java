...
import com.example.dictionary.filter.FormAuthenticationProvider;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    */
    ...
    protected void configure(HttpSecurity http) throws Exception {
        // @formatter:off
        http.authorizeRequests().antMatchers("/login", "/logout-complete", "/users/new", "/user","/login-failure","/error","/").permitAll()
